...
# ── ページに入れるのは、この2行だけ ──
# ?v=ハッシュ は付けません。付けると帯を1文字直すたびに全ページのHTMLが変わり、
# 57ファイルを上げ直すことになります（実際にそうなっていました）。
# 代わりに vercel.json で、このファイルだけ保存期間を5分にしてあります。
