...
# 「調達」は、お金を受け取った側の話。払った額ではないので外す
#   例）三井物産などから約84億円を調達した ← メルカリが受け取った側
NOT=re.compile(r'調達|売上|収益|流通総額|取扱高|預り資産|預金|純利益|営業利益|経常利益|時価総額|市場規模|評価損|減損|目指|目標|見込|計画|想定|規模となる|売却益|特別利益|統合後|企業価値|資産規模|運用総額|残高|時価|市場|成長|規模の|超規模')
